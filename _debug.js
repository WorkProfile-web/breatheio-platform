/**
 * GET /api/_debug
 * Debug endpoint: tests Vercel Blob connectivity and returns the result.
 * No silent error handling — shows you exactly what's failing.
 */
